...
class Command(BaseCommand):
    ...
    def handle_subnet(self, subnet, models):
        ...
        for ip_address in hosts:
            ...
            if is_reachable:
                switch, created = Device.objects.get_or_create(ip=ip_address, snmp_community_ro=settings.SNMP_DEFAULT_COMMUNITY_RO, snmp_community_rw=settings.SNMP_DEFAULT_COMMUNITY_RW)
