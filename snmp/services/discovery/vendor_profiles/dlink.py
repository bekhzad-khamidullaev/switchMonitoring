...
class DlinkVendorProfile(BaseVendorProfile):
    name = "dlink"
    ...
    def supports(
        ...
        return (
            vendor in {"dlink", "d-link"}
            or sys_object_id.startswith("1.3.6.1.4.1.171.")
            or "d-link" in sys_descr
            or "dlink" in sys_descr
        )
